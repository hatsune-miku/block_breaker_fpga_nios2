...
# Memory: onchip_memory2_ram
MEM_0 := nios2_kernel_onchip_memory2_ram
$(MEM_0)_NAME := onchip_memory2_ram
...
$(MEM_0)_HIERARCHICAL_PATH := onchip_memory2_ram
$(MEM_0)_WIDTH := 32
$(MEM_0)_HEX_DATA_WIDTH := 32
$(MEM_0)_ENDIANNESS := --little-endian-mem
$(MEM_0)_CREATE_LANES := 0

.PHONY: onchip_memory2_ram
onchip_memory2_ram: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym

# Memory: onchip_memory2_rom
MEM_1 := nios2_kernel_onchip_memory2_rom
$(MEM_1)_NAME := onchip_memory2_rom
...
$(MEM_1)_HIERARCHICAL_PATH := onchip_memory2_rom
$(MEM_1)_WIDTH := 32
$(MEM_1)_HEX_DATA_WIDTH := 32
$(MEM_1)_ENDIANNESS := --little-endian-mem
$(MEM_1)_CREATE_LANES := 0

.PHONY: onchip_memory2_rom
onchip_memory2_rom: check_elf_exists $(MEM_INIT_DIR)/$(MEM_1).hex $(HDL_SIM_DIR)/$(MEM_1).dat $(HDL_SIM_DIR)/$(MEM_1).sym
