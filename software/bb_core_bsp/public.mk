...
SOPCINFO_FILE := E:/data/project/block_breaker/nios2_kernel.sopcinfo
...
# Design Name 
# setting SOPC_NAME is nios2_kernel
SOPC_NAME := nios2_kernel
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x21270
SOPC_SYSID_FLAG += --sidp=0x21270
ELF_PATCH_FLAG  += --sidp 0x21270

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1648954371
SOPC_SYSID_FLAG += --timestamp=1648954371
ELF_PATCH_FLAG  += --timestamp 1648954371
